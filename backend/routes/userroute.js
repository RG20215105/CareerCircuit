...
const { registerUser,loginUser,logout, forgotpassword,resetPasswords,getuserdetails, updatepass, updateprofile, createpost, getallposts, createcomment} = require("../controllers/usercontroller");
