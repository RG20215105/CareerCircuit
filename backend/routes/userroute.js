...
const { registerUser,loginUser,logout, forgotpassword,resetPasswords,getuserdetails, updatepass, updateprofile, createpost, getallposts} = require("../controllers/usercontroller");
